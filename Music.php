...
<div class="menu">
  <form method="post"> <a href="Music.php" target="_self" style="color: white"> Home</a> 
...
Logout</a>
<a href="cart.php" target="_self" style="color: white" >
	...
	while($row = mysqli_fetch_assoc($result)){
		 if ($qryCat == 'album') {  
			...
			echo '<tr><td align="center">'.$row['GenreId'].'</td><td align="center"> '.$row['Name'].'</td></tr>';} 
                       ...
                       // echo '<tr><th align="center">'.' TrackId '.'</th><th align="center"> '.'Track Name'.'</th><th align="center"> '.'Composer Name'.'</th><th align="center"> '.'Album Title'.'</th><th align="center">'.'Price in $ '.'</th><th align="center"> '.'Add Cart'.'</th></tr>';
			echo'<tr><td align="center">'.$row['TrackId'].'</td><td align="center"> '.$row['Name'].'</td><td align="center"> '.$row['Composer'].'</td><td align="center"> '.$row['Title'].'</td><td align="center"> '.$row['Price'].' </td><td align="center">'.'<a onClick="addToCart('.$row['TrackId'].')"><img src ="sho.png" alt= "Add Cart" height="30" width ="30"  ></a></td></tr>';} 
