...
//	echo '<h3> Search Criteria:'.' '.$qryCat.'</h3>';
	...
	echo "</table>";
	echo "<br><br>";
	echo "<a href='clear_cart.php'><img src='Clear.png' alt='clear cart' height=50 width=100 ></a>";  
    echo "<a href='checkout.php'><img src='place_order.png' alt='place order' height=50  width=100 align='right' ></a>";
